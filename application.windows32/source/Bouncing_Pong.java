...
public class Bouncing_Pong extends PApplet {
...
public void reset() {
  ...
  if (difficulty ==  0) {
    speedX = random(2, 4);
    speedY = random(1.25f, 2);
  } else if (difficulty == 1) {
    speedX = random(3, 6);
    speedY = random(2.5f, 3);
  ...
  score=0;
  // warpPortal Resets
  px = PApplet.parseInt(random(200, width/2));
  py = PApplet.parseInt(random(400, height - 300));
  px2 = PApplet.parseInt(random(width/2, width - 200));
  py2 = PApplet.parseInt(random(300, height - 300));
  sound = 0;
  enterSound = true;
  enterSound2 = true;
  exitSound = true;
...
public void sceneGame() {
 if (enterSound2 == true) {
    out.playNote( 0, 0.2f, "C3" );
    out.playNote( .2f, 0.2f, "E3" );
    out.playNote( .4f, 0.2f, "G3" );
    enterSound2 = false;
  }
...
public void sceneOver() {
  ...
  //Sounds
    if (exitSound == true) {
    out.playNote( .4f, 0.2f, "C3" );
    out.playNote( .2f, 0.2f, "E3" );
    out.playNote( 0, 0.2f, "G3" );
    exitSound = false;
  }
...
public void soundCore() {
  ...
  //Sound cues
  if (sound == 1) {
    out.playNote( 0, 0.5f, "C3" );
  } else if (sound == 2) {
    out.playNote( 0, 0.5f, "C#3" );
  } else if (sound == 3) {
    out.playNote( 0, 0.5f, "D3" );
  } else if (sound == 4) {
    out.playNote( 0, 0.5f, "D#3" );
    ;
  } else if (sound == 5) {
    out.playNote( 0, 0.5f, "E3" );
  } else if (sound == 6) {
    out.playNote( 0, 0.5f, "F3" );
  } else if (sound == 7) {
    out.playNote( 0, 0.5f, "F#3" );
  } else if (sound == 8) {
    out.playNote( 0, 0.5f, "G3" );
  } else if (sound == 9) {
    out.playNote( 0, 0.5f, "G#3" );
  } else if (sound == 10) {
    out.playNote( 0, 0.5f, "A3" );
  } else if (sound == 11) {
    out.playNote( 0, 0.5f, "A#3" );
  } else if (sound == 12) {
    out.playNote( 0, 0.5f, "B3" );
  } else if (sound == 13) {
    out.playNote( 0, 0.2f, "C4" );
    ;
    out.playNote( .2f, 0.2f, "E4" );
    out.playNote( .4f, 0.2f, "G4" );
  }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--hide-stop", "Bouncing_Pong" };
    if (passedArgs != null) {
